...
public abstract class BaseSourceRepositoryService {
	...
	public java.util.List<at.bestsolution.tasktracker.emapping.webservice.dto.DTOSourceRepository> list() {
		try( at.bestsolution.persistence.Session s = sessionFactory.createSession() ) {
			...
			java.util.List<at.bestsolution.tasktracker.model.tasktracker.SourceRepository> list = checkAccess_list(mapper.selectAll(), s);
	...
	protected java.util.List<at.bestsolution.tasktracker.model.tasktracker.SourceRepository> checkAccess_list(java.util.List<at.bestsolution.tasktracker.model.tasktracker.SourceRepository> list, at.bestsolution.persistence.Session session) {
		return list;
	}
	...
	protected at.bestsolution.tasktracker.model.tasktracker.SourceRepository checkAccess_get(at.bestsolution.tasktracker.model.tasktracker.SourceRepository entity, at.bestsolution.persistence.Session session) {
		return entity;
	}
	...
	protected at.bestsolution.tasktracker.model.tasktracker.TaskRepository checkAccess_getRepository(at.bestsolution.tasktracker.model.tasktracker.SourceRepository entity, at.bestsolution.tasktracker.model.tasktracker.TaskRepository value, at.bestsolution.persistence.Session session) {
		return value;
	}
	...
	public at.bestsolution.tasktracker.emapping.webservice.dto.DTOSourceRepository create(at.bestsolution.tasktracker.emapping.webservice.dto.DTOSourceRepository dto) {
		try( at.bestsolution.persistence.Session s = sessionFactory.createSession() ) {
			at.bestsolution.tasktracker.model.tasktracker.SourceRepository entity = checkAccess_create(at.bestsolution.tasktracker.emapping.webservice.mapper.SourceRepositoryDTOMapper.mergeToEntity(
			...
			return get(at.bestsolution.tasktracker.emapping.webservice.mapper.SourceRepositoryDTOMapper.getId(entity));
		}
	}

	protected at.bestsolution.tasktracker.model.tasktracker.SourceRepository checkAccess_create(at.bestsolution.tasktracker.model.tasktracker.SourceRepository entity, at.bestsolution.persistence.Session session) {
		return entity;
	}
	...
	@javax.ws.rs.Path("{id}")
	@javax.ws.rs.Consumes(javax.ws.rs.core.MediaType.APPLICATION_JSON)
	public at.bestsolution.tasktracker.emapping.webservice.dto.DTOSourceRepository update(@javax.ws.rs.PathParam("id") long id, at.bestsolution.tasktracker.emapping.webservice.dto.DTOSourceRepository dto) {
		try( at.bestsolution.persistence.Session s = sessionFactory.createSession() ) {
			at.bestsolution.tasktracker.emapping.SourceRepositoryMapper mapper = s.createMapper(at.bestsolution.tasktracker.emapping.SourceRepositoryMapper.class);
			at.bestsolution.tasktracker.model.tasktracker.SourceRepository entity = checkAccess_update(mapper.selectById(id), s);
	...
	protected at.bestsolution.tasktracker.model.tasktracker.SourceRepository checkAccess_update(at.bestsolution.tasktracker.model.tasktracker.SourceRepository entity, at.bestsolution.persistence.Session session) {
		return entity;
	}
