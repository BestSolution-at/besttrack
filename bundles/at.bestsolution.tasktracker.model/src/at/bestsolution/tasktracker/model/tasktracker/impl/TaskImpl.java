 ...
 * </p>
 * <ul>
 *   <li>{@link at.bestsolution.tasktracker.model.tasktracker.impl.TaskImpl#getRepository <em>Repository</em>}</li>
 *   <li>{@link at.bestsolution.tasktracker.model.tasktracker.impl.TaskImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link at.bestsolution.tasktracker.model.tasktracker.impl.TaskImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link at.bestsolution.tasktracker.model.tasktracker.impl.TaskImpl#getCommentList <em>Comment List</em>}</li>
 *   <li>{@link at.bestsolution.tasktracker.model.tasktracker.impl.TaskImpl#getChangeSetList <em>Change Set List</em>}</li>
 *   <li>{@link at.bestsolution.tasktracker.model.tasktracker.impl.TaskImpl#getReporter <em>Reporter</em>}</li>
 *   <li>{@link at.bestsolution.tasktracker.model.tasktracker.impl.TaskImpl#getAssignee <em>Assignee</em>}</li>
 *   <li>{@link at.bestsolution.tasktracker.model.tasktracker.impl.TaskImpl#getState <em>State</em>}</li>
 *   <li>{@link at.bestsolution.tasktracker.model.tasktracker.impl.TaskImpl#getTargetVersion <em>Target Version</em>}</li>
 *   <li>{@link at.bestsolution.tasktracker.model.tasktracker.impl.TaskImpl#getProductVersion <em>Product Version</em>}</li>
 *   <li>{@link at.bestsolution.tasktracker.model.tasktracker.impl.TaskImpl#getAttachmentList <em>Attachment List</em>}</li>
 *   <li>{@link at.bestsolution.tasktracker.model.tasktracker.impl.TaskImpl#getExternalBugId <em>External Bug Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TaskImpl extends BaseObjectImpl implements Task {
	...
	/**
	 * The default value of the '{@link #getExternalBugId() <em>External Bug Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final String EXTERNAL_BUG_ID_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getExternalBugId() <em>External Bug Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getExternalBugId()
	 * @generated
	 * @ordered
	 */
	protected String externalBugId = EXTERNAL_BUG_ID_EDEFAULT;
	...
	public void setRepository(TaskRepository newRepository) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TasktrackerPackage.TASK__REPOSITORY, oldRepository, repository));
	}
	 ...
	 * @generated
	 */
	public void setExternalBugId(String newExternalBugId) {
		String oldExternalBugId = externalBugId;
		externalBugId = newExternalBugId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TasktrackerPackage.TASK__EXTERNAL_BUG_ID, oldExternalBugId, externalBugId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TasktrackerPackage.TASK__EXTERNAL_BUG_ID:
				return getExternalBugId();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case TasktrackerPackage.TASK__ATTACHMENT_LIST:
				...
				return;
			case TasktrackerPackage.TASK__EXTERNAL_BUG_ID:
				setExternalBugId((String)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case TasktrackerPackage.TASK__ATTACHMENT_LIST:
				...
				return;
			case TasktrackerPackage.TASK__EXTERNAL_BUG_ID:
				setExternalBugId(EXTERNAL_BUG_ID_EDEFAULT);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case TasktrackerPackage.TASK__EXTERNAL_BUG_ID:
				return EXTERNAL_BUG_ID_EDEFAULT == null ? externalBugId != null : !EXTERNAL_BUG_ID_EDEFAULT.equals(externalBugId);
		}
