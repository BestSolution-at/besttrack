...
import at.bestsolution.tasktracker.model.tasktracker.Attachment;
...
import at.bestsolution.tasktracker.model.tasktracker.SourceRepositoryType;
...
import at.bestsolution.tasktracker.model.tasktracker.TaskState;
...
public class TasktrackerPackageImpl extends EPackageImpl implements TasktrackerPackage {
	 ...
	 * @generated
	 */
	private EClass repositoryPersonEClass = null;
	 ...
	 * @see at.bestsolution.tasktracker.model.tasktracker.TasktrackerPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EAttribute getTaskRepository_Description() {
		return (EAttribute)taskRepositoryEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getTaskRepository_Children() {
		return (EReference)taskRepositoryEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EReference getTaskRepository_Parent() {
		return (EReference)taskRepositoryEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 * @generated
	 */
	public EAttribute getTaskRepository_ExternalId() {
		return (EAttribute)taskRepositoryEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 * @generated
	 */
	public EAttribute getTaskRepository_PublicRepo() {
		return (EAttribute)taskRepositoryEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 * @generated
	 */
	public EReference getPerson_RepositoryList() {
	 ...
	 * @generated
	 */
	public EAttribute getTask_ExternalBugId() {
	 ...
	 * @generated
	 */
	public EClass getRepositoryPerson() {
		return repositoryPersonEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getRepositoryPerson_Person() {
		return (EReference)repositoryPersonEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getRepositoryPerson_Repository() {
		return (EReference)repositoryPersonEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getRepositoryPerson_PrivilegeMask() {
		return (EAttribute)repositoryPersonEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEReference(taskRepositoryEClass, TASK_REPOSITORY__CHILDREN);
		createEReference(taskRepositoryEClass, TASK_REPOSITORY__PARENT);
		createEAttribute(taskRepositoryEClass, TASK_REPOSITORY__EXTERNAL_ID);
		createEAttribute(taskRepositoryEClass, TASK_REPOSITORY__PUBLIC_REPO);

		personEClass = createEClass(PERSON);
		createEAttribute(personEClass, PERSON__FIRSTNAME);
		createEAttribute(personEClass, PERSON__LASTNAME);
		createEReference(personEClass, PERSON__REPOSITORY_LIST);
		...
		createEAttribute(taskEClass, TASK__EXTERNAL_BUG_ID);
		...
		repositoryPersonEClass = createEClass(REPOSITORY_PERSON);
		createEReference(repositoryPersonEClass, REPOSITORY_PERSON__PERSON);
		createEReference(repositoryPersonEClass, REPOSITORY_PERSON__REPOSITORY);
		createEAttribute(repositoryPersonEClass, REPOSITORY_PERSON__PRIVILEGE_MASK);
	...
	public void initializePackageContents() {
		...
		repositoryPersonEClass.getESuperTypes().add(this.getBaseObject());
		...
		initEReference(getTaskRepository_PersonList(), this.getRepositoryPerson(), this.getRepositoryPerson_Repository(), "personList", null, 0, -1, TaskRepository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTaskRepository_Children(), this.getTaskRepository(), null, "children", null, 0, -1, TaskRepository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTaskRepository_Parent(), this.getTaskRepository(), null, "parent", null, 0, 1, TaskRepository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTaskRepository_ExternalId(), ecorePackage.getEBoolean(), "externalId", null, 0, 1, TaskRepository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTaskRepository_PublicRepo(), ecorePackage.getEBoolean(), "publicRepo", null, 0, 1, TaskRepository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPerson_RepositoryList(), this.getRepositoryPerson(), this.getRepositoryPerson_Person(), "repositoryList", null, 0, -1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(taskEClass, Task.class, "Task", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTask_Repository(), this.getTaskRepository(), null, "repository", null, 0, 1, Task.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTask_ExternalBugId(), ecorePackage.getEString(), "externalBugId", null, 0, 1, Task.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(repositoryPersonEClass, RepositoryPerson.class, "RepositoryPerson", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRepositoryPerson_Person(), this.getPerson(), this.getPerson_RepositoryList(), "person", null, 0, 1, RepositoryPerson.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRepositoryPerson_Repository(), this.getTaskRepository(), this.getTaskRepository_PersonList(), "repository", null, 0, 1, RepositoryPerson.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRepositoryPerson_PrivilegeMask(), ecorePackage.getELong(), "privilegeMask", null, 0, 1, RepositoryPerson.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
