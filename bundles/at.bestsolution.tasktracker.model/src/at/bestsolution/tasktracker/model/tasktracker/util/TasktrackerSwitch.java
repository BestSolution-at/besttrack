...
public class TasktrackerSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TasktrackerPackage.REPOSITORY_PERSON: {
				RepositoryPerson repositoryPerson = (RepositoryPerson)theEObject;
				T result = caseRepositoryPerson(repositoryPerson);
				if (result == null) result = caseBaseObject(repositoryPerson);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Repository Person</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Repository Person</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRepositoryPerson(RepositoryPerson object) {
		return null;
	}
